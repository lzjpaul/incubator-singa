...
def load_data(
  ...
  path_train = data_dir + '/train_data_normrange_PEARSON.bin'
  path_test  = data_dir + '/test_data_normrange_PEARSON.bin'
  path_valid = data_dir + '/valid_data_normrange_PEARSON.bin'
