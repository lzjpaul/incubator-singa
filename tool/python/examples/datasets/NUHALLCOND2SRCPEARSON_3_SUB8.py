...
def load_data(
  ...
  data_dir = '/data/zhaojing/cnn/NUHALLCOND/2-sources/subsample8'
  path_train = data_dir + '/train_data_normrange_PEARSON_3.bin'
  path_test  = data_dir + '/test_data_normrange_PEARSON_3.bin'
  path_valid = data_dir + '/valid_data_normrange_PEARSON_3.bin'
