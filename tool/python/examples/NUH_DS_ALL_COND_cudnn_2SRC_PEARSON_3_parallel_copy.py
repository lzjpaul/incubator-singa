...
pad_x_param = 2
pad_y_param = 0
filter_num_param_array = np.array([100, 200])
...
layer = Concate(dim=3, num=3)
m.add(layer, [layers_name[1], layers_name[3], layers_name[5]])
layers_name.append(layer.layer.name)
...
m.add(layer, [layers_name[8], "data0"])
layers_name.append(layer.layer.name)
