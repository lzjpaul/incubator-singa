...
from examples.datasets import NUHALLCOND2SRCARBI
import numpy as np
import random
...
X_train, X_test, X_valid, workspace = NUHALLCOND2SRCARBI.load_data()

version_num = random.randint(0,10000)
data_dir_prefix = '/data/zhaojing/result/1-31-CNN-2SRC-ARBI'
