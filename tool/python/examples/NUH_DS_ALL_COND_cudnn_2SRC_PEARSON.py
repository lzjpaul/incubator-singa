...
from examples.datasets import NUHALLCOND2SRCPEARSON
import numpy as np
import random
...
X_train, X_test, X_valid, workspace = NUHALLCOND2SRCPEARSON.load_data()

version_num = random.randint(0,10000)
data_dir_prefix = '/data/zhaojing/result/1-19-CNN-PEARSON'
...
stride_x_param_array = np.array([10, 20, 25, 30, 35])
