...
from examples.datasets import CMS1SRCKB
import numpy as np
import random
...
X_train, X_test, X_valid, workspace = CMS1SRCKB.load_data()

version_num = random.randint(0,10000)
data_dir_prefix = '/data/zhaojing/result/2-4-CNN-CMS-1SRC-KB'
...
kernel_x_param_array = np.array([6, 10, 15, 20, 25, 30])
