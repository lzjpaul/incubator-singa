...
data_dir_prefix = '/data/zhaojing/result/2-5-CMS-CNN-2layer-KB'
...
kernel_x_param_array = np.array([3, 6, 10, 15, 20, 25, 30, 35, 40, 45])
...
for i in range(layer_num):
    if i == 0:
        kernel_x_param[i] = kernel_x_param_array[random.randint(1,len(kernel_x_param_array)-1)]
