...
data_dir_prefix = '/data/zhaojing/result/2-5-CNN-2layer-PEARSON-3'
...
input_channel = 1
filter_num_param_array = np.array([150, 200, 250, 300, 350, 400, 450, 500, 600, 700, 800, 900, 1000])
...
for i in range(layer_num):
    if i == 0:
        ...
        filter_num_param[i] = filter_num_param_array[random.randint(7,len(filter_num_param_array)-3)] # 500 - 800
    elif i == 1:
