...
data_dir_prefix = '/data/zhaojing/result/2-5-CMS-CNN-2layer-PEARSON'
...
input_channel = 1
filter_num_param_array = np.array([150, 200, 250, 300, 350, 400, 450, 500, 600])
...
for i in range(layer_num):
    if i == 0:
        ...
        # stride step less
        stride_x_param[i] = stride_x_param_array[random.randint(1,2)]
        ...
        kernel_y_param[i] = kernel_y_param_array[random.randint(0,len(kernel_y_param_array)-1)]
        stride_x_param[i] = stride_x_param_array[random.randint(1,2)] #1,2,3
