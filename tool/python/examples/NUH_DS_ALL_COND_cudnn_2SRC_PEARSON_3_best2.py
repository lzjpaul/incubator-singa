...
if pool_x_param == 2:
    pool_stride_x_param = pool_stride_y_param = pool_stride_param_array[1]
else:
...
conv_n_array = np.array([(conv_fan_in + conv_fan_out_1)/2])
...
softmax_n_array = np.array([(softmax_fan_in + softmax_fan_out)/2])
