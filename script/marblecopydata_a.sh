#!/bin/bash
hostfile="/home/singa/zhaojing/NUH-singa/incubator-singa/script/marbleslaves_a"
...
#for i in ${hosts[@]}
for i in `cat /home/singa/zhaojing/NUH-singa/incubator-singa/script/marbleslaves_a`
do
    echo $i
      echo "ssh $i"
