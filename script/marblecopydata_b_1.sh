#!/bin/bash
hostfile="/home/singa/zhaojing/NUH-singa/incubator-singa/script/marbleslaves_b_1"
...
#for i in ${hosts[@]}
for i in `cat /home/singa/zhaojing/NUH-singa/incubator-singa/script/marbleslaves_b_1`
do
    echo $i
      echo "ssh $i"
