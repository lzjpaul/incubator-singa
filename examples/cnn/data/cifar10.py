...
def load_train_data(dir_path='/home/sadm/singa_data/cifar-10-batches-py', num_batches=5):
    labels = []
    batchsize = 10000
...
def load_test_data(dir_path='/home/sadm/singa_data/cifar-10-batches-py'):
