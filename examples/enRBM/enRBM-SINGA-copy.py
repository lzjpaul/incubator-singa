...
def train(data_file, label_file, correl_file, h_dim, train_num, use_gpu, num_epoch=10, batch_size=100):
    ...
    smooth_costant = 0.01 # smooth penalty
    ...
    for epoch in range(num_epoch):
        ...
        for b in range(num_train_batch):
            ...
            tgweight = tgweight + smooth_penalty * tensor.mult(tcorrelmatrix, tweight)
        ...
        if epoch == num_epoch:
            return tvalidposhidprob, valid_y
...
if __name__ == '__main__':
    ...
    tvalidposhidprob, valid_y = train(args.datafile, args.labelfile, args.correlfile, args.hdim, args.trainnum, args.use_gpu)
