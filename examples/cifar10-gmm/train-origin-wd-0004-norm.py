...
"""
# bias not doing regularization
# random seed every epoch
import cPickle
import numpy as np
import os
import argparse
...
def train(data, net, max_epoch, get_lr, weight_decay, batch_size=100,
    ...
    opt_0 = optimizer.SGD(momentum=0.9, weight_decay=0.0)
        ...
        for b in range(num_train_batch):
            ...
            for (s, p, g) in zip(net.param_names(), net.param_values(), grads):
                ...
                if 'weight' in str(s):
                    ...
                    opt_0.apply_with_lr(epoch, get_lr(epoch), g, p, str(s), b)
            # update progress bar
...
if __name__ == '__main__':
    ...
    if args.model == 'caffe':
        ...
        train((train_x, train_y, test_x, test_y), net, 200, alexnet_lr, 0.004,
              use_cpu=args.use_cpu)
    elif args.model == 'vgg':
