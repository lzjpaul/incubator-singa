...
//./create_data.bin 12 1277 5207 3000 2000 /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUcnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_train_label.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_test_data.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_test_label.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_valid_data.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_valid_label.csv /data/zhaojing/cnn/NUHALLCOND/try_index/
