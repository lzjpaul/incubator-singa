...
const int kCOLSize = 1277; //modified here
const int kNUHHFNBytes = kROWSize * kCOLSize;
const int kTrainBatchSize = 5207;  //all the records, modified here
const int kTestBatchSize = 3000;  //all the records, modified here
const int kValidBatchSize = 2000;  //all the records, modified here
...
#./create_data.bin /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_train_data.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_train_label.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_test_data.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_test_label.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_valid_data.csv /data/zhaojing/cnn/NUHALLCOND/NUH_DS_SOC_READMIT_DIAG_INOUTPATIENT_CNN_SAMPLE_CASE_valid_label.csv /data/zhaojing/cnn/NUHALLCOND/subsample1/
