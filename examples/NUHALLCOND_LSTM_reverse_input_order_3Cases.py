...
#only reserve the last 5 cases
train_data_matrix = train_data_matrix[:,6:12, :]
test_data_matrix = test_data_matrix[:,6:12, :]

print ("new train_data_matrix = ", train_data_matrix.shape)
print ("new test_data_matrix = ", test_data_matrix.shape)
