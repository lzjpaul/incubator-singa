...
numpy.savetxt("GRU_512_5_epoch_prediction_unplanned.txt", c, fmt = '%6f', delimiter=",") #modify here
d = numpy.asarray(test_label_matrix, dtype = int)
numpy.savetxt("GRU_512_5_epoch_label_unplanned.txt", d, fmt = '%d', delimiter=",") #modify here
