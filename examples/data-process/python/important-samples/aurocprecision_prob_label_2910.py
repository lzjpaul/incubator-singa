...
y_true, y_scores = all_label_matrix.astype(np.int), all_prob_matrix.astype(np.float) #modify here0:1018!!!!!!! less than 1018
...
# python aurocprecision_prob_label_2910.py 0 2910 LSTM_1024_5_epoch/LSTM_1024_5_epoch_label_1col.csv LSTM_1024_5_epoch/LSTM_1024_5_epoch_prediction_1col.csv 0 20 LSTM_1024_5_epoch/correct_label_0_index.csv LSTM_1024_5_epoch/correct_label_1_index.csv LSTM_1024_5_epoch/vague_index.csv LSTM_1024_5_epoch/incorrect_label_0_index.csv LSTM_1024_5_epoch/incorrect_label_1_index.csv
