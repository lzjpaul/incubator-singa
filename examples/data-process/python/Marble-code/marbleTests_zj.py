...
print "begin marble = MarbleAPR(X, 3, 0.1)"
marble = MarbleAPR(X, 3, 0.1);
print "after marble = MarbleAPR(X, 3, 0.1)"

print "begin compute_decomp"
iterInfo, ll = marble.compute_decomp(gamma = [0.0001, 0.01, 0.01], gradual = True, max_inner = 1, max_iter = 1, del_tol = 0.01)
print "after compute_decomp"
