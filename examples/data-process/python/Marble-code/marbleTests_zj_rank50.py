...
np.random.seed(10)
projMat_test, biasMat_test = marble.project_data(Xhat, 0, max_iter = 3, max_inner = 5, delta_tol = 0.01)
projMat_train, biasMat_train = marble.project_data(X, 0, max_iter = 3, max_inner = 5, delta_tol = 0.01)
# print "projMat = \n\n", projMat
# print "biasMat = \n\n", biasMat
