...
marble = MarbleAPR(X, 25, 0.1);

iterInfo, ll = marble.compute_decomp(gamma = [0.0001, 0.01, 0.01], gradual = True, max_inner = 10, max_iter = 150, del_tol = 0.01)
...
np.random.seed(10)
projMat_test, biasMat_test = marble.project_data(Xhat, 0, max_iter = 100, max_inner = 10, delta_tol = 0.01)
projMat_train, biasMat_train = marble.project_data(X, 0, max_iter = 100, max_inner = 10, delta_tol = 0.01)
# print "projMat = \n\n", projMat
# print "biasMat = \n\n", biasMat
