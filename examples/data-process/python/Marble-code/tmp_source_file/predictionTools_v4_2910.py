...
# python predictionTools_v4_2910.py /data/zhaojing/cnn/MARBLE/label/subsample1/NUH_DS_SOC_READMIT_DIAG_LAB_INOUTPATIENT_CNN_SAMPLE_CASE_PEARSON_3_train_label_normrange_1.csv ../NUHALLCOND-PEARSON-3-membership/membership_train_S1_25_1.txt ../NUHALLCOND-PEARSON-3-membership/membership_test_S1_25_1.txt /data/zhaojing/cnn/MARBLE/label/subsample1/NUH_DS_SOC_READMIT_DIAG_LAB_INOUTPATIENT_CNN_SAMPLE_CASE_PEARSON_3_test_label_normrange_1.csv
