        ...
        for kernel_x in [80]:
            for stride_x in [10]:
                ...
                for var in variances: 
                    ...
                    check_file = '_'.join(['new_parameter', str(kernel_y), str(kernel_x), str(stride_y), str(stride_x), str(threshold), str(var), '001'])
                    ...
                    file_s = "_".join(['readmitted_prob', str(kernel_y), str(kernel_x), str(stride_y), str(stride_x), str(threshold), str(var), '001'])
                    file_s += '.csv'
