# 1-7: only the lasso, param from 100
...
if __name__ == '__main__':
    ...
    param_lasso = {'estimator__C': [1000, 100, 10, 1, 0.1, 1e-2],
                   'estimator__lambd': [1000, 100, 10, 1, 0.1, 1e-2, 1e-3],
                   # 'estimator__lambd': [10],
 ...
 #                  }
    ...
    param_smoothing = {'estimator__C': [1000, 100, 10, 1, 0.1, 1e-2],
                       'estimator__lambd': [1000, 100, 10, 1, 0.1, 1e-2, 1e-3],
                       'estimator__batch_size': [args.batchsize]
                       #'estimator__alpha': [10000, 1000, 100, 10, 1, 0.1, 1e-2, 1e-3, 1e-4]
                      }
