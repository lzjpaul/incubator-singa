...
if __name__ == '__main__':
    ...
    print "gm_lambda_ratio_list: ", gm_lambda_ratio_list
    print "a_list: ", a_list
    ...
    print "gm_lambda_ratio, a_val_num, alpha_val_num, b_val_num: ", gm_lambda_ratio, a_val_num, alpha_val_num, b_val_num
