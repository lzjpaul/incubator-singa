...
if __name__ == '__main__':
    ...
    if args.model == 'caffe':
        ...
        train((train_x, train_y, test_x, test_y), net, 160, alexnet_lr, 0.0,
        ...
        train((train_x, train_y, test_x, test_y), net, 250, vgg_lr, 0.0,
              use_cpu=args.use_cpu)
        done = time.time()
        do = datetime.datetime.fromtimestamp(done).strftime('%Y-%m-%d %H:%M:%S')
        print do
        ...
        train((train_x, train_y, test_x, test_y), net, 200, resnet_lr, 0.0,
              use_cpu=args.use_cpu)
        done = time.time()
        do = datetime.datetime.fromtimestamp(done).strftime('%Y-%m-%d %H:%M:%S')
        print do
